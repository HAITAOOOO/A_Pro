...
#define IIC1_SCL_GPIO_CLK_ENABLE()       do{ __HAL_RCC_GPIOE_CLK_ENABLE(); }while(0)   /* PB口时钟使能 */

#define IIC1_SDA_GPIO_PORT               IIC1_SDA_GPIO_Port
#define IIC1_SDA_GPIO_PIN                IIC1_SDA_Pin
#define IIC1_SDA_GPIO_CLK_ENABLE()       do{ __HAL_RCC_GPIOE_CLK_ENABLE(); }while(0)   /* PB口时钟使能 */

#define IIC2_SCL_GPIO_PORT               IIC2_SCL_GPIO_Port
#define IIC2_SCL_GPIO_PIN                IIC2_SCL_Pin
#define IIC2_SCL_GPIO_CLK_ENABLE()       do{ __HAL_RCC_GPIOE_CLK_ENABLE(); }while(0)   /* PB口时钟使能 */

#define IIC2_SDA_GPIO_PORT               IIC2_SDA_GPIO_Port
#define IIC2_SDA_GPIO_PIN                IIC2_SDA_Pin
#define IIC2_SDA_GPIO_CLK_ENABLE()       do{ __HAL_RCC_GPIOE_CLK_ENABLE(); }while(0)   /* PB口时钟使能 */


#define IIC3_SCL_GPIO_PORT               IIC3_SCL_GPIO_Port
#define IIC3_SCL_GPIO_PIN                IIC3_SCL_Pin
#define IIC3_SCL_GPIO_CLK_ENABLE()       do{ __HAL_RCC_GPIOE_CLK_ENABLE(); }while(0)   /* PB口时钟使能 */

#define IIC3_SDA_GPIO_PORT               IIC3_SDA_GPIO_Port
#define IIC3_SDA_GPIO_PIN                IIC3_SDA_Pin
#define IIC3_SDA_GPIO_CLK_ENABLE()       do{ __HAL_RCC_GPIOE_CLK_ENABLE(); }while(0)   /* PB口时钟使能 */

#define IIC4_SCL_GPIO_PORT               IIC4_SCL_GPIO_Port
#define IIC4_SCL_GPIO_PIN                IIC4_SCL_Pin
#define IIC4_SCL_GPIO_CLK_ENABLE()       do{ __HAL_RCC_GPIOE_CLK_ENABLE(); }while(0)   /* PB口时钟使能 */

#define IIC4_SDA_GPIO_PORT               IIC4_SDA_GPIO_Port
#define IIC4_SDA_GPIO_PIN                IIC4_SDA_Pin
#define IIC4_SDA_GPIO_CLK_ENABLE()       do{ __HAL_RCC_GPIOE_CLK_ENABLE(); }while(0)   /* PB口时钟使能 */
...
#define IIC1_SCL(x)        do{ x ? \
                              ...
                              HAL_GPIO_WritePin(IIC1_SCL_GPIO_Port, IIC1_SCL_Pin, GPIO_PIN_RESET); \
                          }while(0)       /* SCL */

#define IIC1_SDA(x)        do{ x ? \
                              HAL_GPIO_WritePin(IIC1_SDA_GPIO_Port, IIC1_SDA_Pin, GPIO_PIN_SET) : \
                              HAL_GPIO_WritePin(IIC1_SDA_GPIO_Port, IIC1_SDA_Pin, GPIO_PIN_RESET); \
                          }while(0)       /* SDA */
...
#define IIC3_SCL(x)        do{ x ? \
                              HAL_GPIO_WritePin(IIC3_SCL_GPIO_Port, IIC3_SCL_Pin, GPIO_PIN_SET) : \
                              HAL_GPIO_WritePin(IIC3_SCL_GPIO_Port, IIC3_SCL_Pin, GPIO_PIN_RESET); \
                          }while(0)       /* SCL */

#define IIC3_SDA(x)        do{ x ? \
                              HAL_GPIO_WritePin(IIC3_SDA_GPIO_Port, IIC3_SDA_Pin, GPIO_PIN_SET) : \
                              HAL_GPIO_WritePin(IIC3_SDA_GPIO_Port, IIC3_SDA_Pin, GPIO_PIN_RESET); \
                          }while(0)       /* SDA */
...
#define IIC4_SCL(x)        do{ x ? \
                              HAL_GPIO_WritePin(IIC4_SCL_GPIO_Port, IIC4_SCL_Pin, GPIO_PIN_SET) : \
                              HAL_GPIO_WritePin(IIC4_SCL_GPIO_Port, IIC4_SCL_Pin, GPIO_PIN_RESET); \
                          }while(0)       /* SCL */

#define IIC4_SDA(x)        do{ x ? \
                              HAL_GPIO_WritePin(IIC4_SDA_GPIO_Port, IIC4_SDA_Pin, GPIO_PIN_SET) : \
                              HAL_GPIO_WritePin(IIC4_SDA_GPIO_Port, IIC4_SDA_Pin, GPIO_PIN_RESET); \
                          }while(0)       /* SDA */
