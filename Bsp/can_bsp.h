...
#define CAN_BSP_H
#include "main.h"
//3508 2006电机控制电流, 范围 [-16384,16384]
typedef enum
{
...
extern motor_measure_t  can1_motor_message[8];
extern motor_measure_t  can2_motor_message[8];
extern moto_info_t can_motor_message_6020[7];
